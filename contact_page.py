...
def contact_page():
    ...
    a.image('assets/figures/murdoch.png')
    a.markdown("""<span style="font-size:18px;">University of Pittsburgh, UPMC Hillman Cancer Center, Assembly Building</span>""", unsafe_allow_html=True)
    ...
    b.markdown("""<div style="position:relative;padding-bottom:100%;">
               ...
               src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=3420%20Forbes%20Avenue%20Pittsburgh,%20PA%2015213+(My%20Business%20Name)&amp;t=p&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
